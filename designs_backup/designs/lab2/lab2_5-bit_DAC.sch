...
C {lab_pin.sym} -240 -100 0 0 {name=p1 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -100 -30 0 0 {name=p2 sig_type=std_logic lab=DAC_REF}
C {lab_pin.sym} 100 -30 0 0 {name=p3 sig_type=std_logic lab=DAC_REF}
C {lab_pin.sym} 300 -30 0 0 {name=p4 sig_type=std_logic lab=DAC_REF}
C {lab_pin.sym} 500 -30 0 0 {name=p5 sig_type=std_logic lab=DAC_REF}
C {lab_pin.sym} -300 -30 0 0 {name=p6 sig_type=std_logic lab=DAC_REF}
C {lab_pin.sym} -300 90 0 0 {name=p7 sig_type=std_logic lab=b[0]}
...
C {lab_pin.sym} -100 90 0 0 {name=p11 sig_type=std_logic lab=b[1]}
C {lab_pin.sym} 100 90 0 0 {name=p12 sig_type=std_logic lab=b[2]}
C {lab_pin.sym} 300 90 0 0 {name=p13 sig_type=std_logic lab=b[3]}
C {lab_pin.sym} 500 90 0 0 {name=p14 sig_type=std_logic lab=b[4]}
C {opin.sym} -260 -140 0 0 {name=p15 lab=I_DAC}
C {lab_pin.sym} 620 160 0 1 {name=p16 sig_type=std_logic lab=I_DAC}
